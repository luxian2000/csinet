...
class Compressor(ms.nn.Cell):
    ...
    def construct(self, x):
        ...
        x = x.reshape((x.shape[0], self.img_dim))
...
print('x_train的原始维度:', x_train.shape)
...
ansatz = Ansatz10(total_qubits, layers).circuit
ansatz.as_ansatz()
